...
<!-- Start of header Center -->
        <div class="headerCenter" id="home">
            <?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
                <img class="wow fadeInUp" data-wow-duration="1s" data-wow-offset="5" src="<?php bloginfo("template_url")?>/images/logo.svg">
    ...
    <?php while( has_sub_field('portfolio') ): ?>
        ...
        <div class="portfolio-item gallery-cell">
            ...
            <div class="portfolio-info ">
                ...
                <!-- portfolio link -->
               <a class="button" target="_blank" href="<?php the_sub_field('portfolio-link'); ?>">Live Site</a>
       ...
       <!-- contact information -->
        <div class="infoparent">
             <div class="info wow fadeInUp" data-wow-duration="1s"  data-wow-offset="5">
                <a href="mailto:hello@wyndcreative.com">
                    <h2><i class="fa fa-envelope"></i><span>Email</span></h2>
                    <div class="line"></div>
                    <p>hello@wyndcreative.com</p>
                </a>
            </div>
            <div class="info wow fadeInUp" data-wow-duration="1s"  data-wow-offset="5">
            ...
            <div class="info wow fadeInUp" data-wow-duration="1s"  data-wow-offset="5">
                <a  target="_blank" href="https://github.com/magdalena555">  
